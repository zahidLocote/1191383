...
namespace practica14.Controllers
{
    public class DetalleVentumsController : Controller
    {
        ...
        {
            var mvccrudContext = _context.DetalleVenta.Include(d => d.Producto).Include(d => d.Venta);
        ...
        public async Task<IActionResult> Create([Bind("DetalleVentaId,VentaId,ProductoId,Cantidad,PrecioUnitario,Subtotal")] DetalleVentum detalleVentum)
        {
            ...
            ViewData["ProductoId"] = new SelectList(_context.Productos, "Id", "Id", detalleVentum.ProductoId);
